    ...
    <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
      ...
      <div className="container">
        ...
        <div className='max-w-lg mx-auto'>
          ...
          <p className='mt-4 text-center text-white/60 md:text-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias provident quod architecto. Commodi, autem vel?</p>
        </div>
